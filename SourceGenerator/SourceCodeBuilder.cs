...
//        var model = compilation.GetSemanticModel(compilation.SyntaxTrees.Skip(0).First());
        ...
        RecordDeclarationSyntax CreateRecord(string name) =>
            SyntaxFactory.RecordDeclaration(SyntaxFactory.Token(SyntaxKind.RecordDeclaration), SyntaxFactory.Identifier(name))
                .AddModifiers(SyntaxFactory.Token(SyntaxKind.PublicKeyword))
                .AddModifiers(SyntaxFactory.Token(SyntaxKind.PartialKeyword));
        ...
        {
            ns = ns.AddMembers(CreateRecord(className));
        }
